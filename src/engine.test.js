...
test('the existing Engine weighting, decay and exclusions stay numerically unchanged',()=>{
  ...
  const decay=41/42;
  expect(engineModel(sessions,new Date('2026-09-04T12:00:00')).score).toBeCloseTo(480/42*decay**3+45/42*decay**2+36/42*decay,10);
});
